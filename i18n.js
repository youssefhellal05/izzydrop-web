(()=>{
  ...
  const exactAr={
    ...
    'Available':'متاح',
    'More':'المزيد',
    'Add a price':'أضف سعرًا',
    'Your product':'منتجك',
    'Live preview':'معاينة مباشرة',
    'Inventory':'المخزون',
    'Listing progress':'تقدم إضافة المنتج',
    ...
    'Versions':'النسخ',
    'Complete the required details above.':'أكمل البيانات المطلوبة بالأعلى.',
    'One last check before this product appears in the marketplace.':'مراجعة أخيرة قبل ظهور المنتج في السوق.',
    'Your variants will appear here after you build them.':'ستظهر خيارات المنتج هنا بعد إنشائها.',
    'Set stock for every version you sell. Turn off combinations that do not exist.':'حدد المخزون لكل نسخة تبيعها، وأوقف التركيبات غير الموجودة.',
    '4. Inventory by variant':'4. المخزون حسب الخيار',
    'Apply defaults to all variants':'تطبيق الأسعار الافتراضية على كل الخيارات',
    'The product prices above will be used for every variant.':'سيتم استخدام أسعار المنتج بالأعلى لكل الخيارات.',
    'Prices vary by variant':'الأسعار تختلف حسب الخيار',
    'Same price for all':'نفس السعر للجميع',
    'Your product prices from the Pricing section are the defaults.':'أسعار المنتج في قسم التسعير هي الأسعار الافتراضية.',
    '3. How are variants priced?':'3. كيف يتم تسعير الخيارات؟',
    'Add option values first':'أضف قيم الخيارات أولًا',
    'Add an option and its values to see how many variants will be created.':'أضف خيارًا وقيمه لمعرفة عدد الخيارات التي سيتم إنشاؤها.',
    '2. Build the sellable versions':'2. أنشئ النسخ القابلة للبيع',
    'Choose up to 3 option types. Example: Color + Size.':'اختر حتى 3 أنواع من الخيارات. مثال: اللون + المقاس.',
    '1. What can the customer choose?':'1. ماذا يمكن للعميل أن يختار؟',
    'Hide SKU & weight':'إخفاء SKU والوزن',
    'Add SKU & weight':'إضافة SKU والوزن',
    'Tell IzzyDrop what customers can choose. We will build the exact sellable versions.':'أخبر IzzyDrop بما يمكن للعميل اختياره، وسننشئ النسخ القابلة للبيع بدقة.',
    'Options & variants':'الخيارات والنسخ',
    'Enter the number of units currently ready to sell.':'أدخل عدد الوحدات الجاهزة للبيع حاليًا.',
    'Available stock':'المخزون المتاح',
    'Color, size, model, storage, material, or custom options.':'لون أو مقاس أو موديل أو سعة أو خامة أو خيارات مخصصة.',
    'One product, one stock number.':'منتج واحد ورقم مخزون واحد.',
    'Most products only need one stock number. Use options only when the customer chooses between versions.':'معظم المنتجات تحتاج رقم مخزون واحد فقط. استخدم الخيارات فقط عندما يختار العميل بين نسخ مختلفة.',
    'How many versions does this product have?':'كم نسخة أو خيارًا لهذا المنتج؟',
    'Choose the simplest setup that matches how this product is actually sold.':'اختر أبسط إعداد يطابق طريقة بيع هذا المنتج فعليًا.',
    'Inventory & options':'المخزون والخيارات',
    'You do not set a delivery fee here. IzzyDrop calculates delivery separately for the order and destination.':'لا تحدد تكلفة التوصيل هنا. يحسب IzzyDrop التوصيل بشكل منفصل حسب الطلب والوجهة.',
    'Delivery is handled by IzzyDrop':'IzzyDrop يتولى التوصيل',
    'Suggested product margin':'هامش المنتج المقترح',
    'Dropshippers can still choose their own customer price.':'يمكن للدروبشيبر اختيار سعر البيع النهائي بنفسه.',
    'This is what you receive for one unit before IzzyDrop fees or adjustments.':'هذا ما تحصل عليه مقابل الوحدة قبل أي رسوم أو تعديلات من IzzyDrop.',
    'Set what the dropshipper pays you and the customer price you recommend.':'حدد ما يدفعه لك الدروبشيبر وسعر العميل الذي تقترحه.',
    'No photos yet. Add at least one clear product photo.':'لا توجد صور بعد. أضف صورة واضحة واحدة على الأقل للمنتج.',
    'Add photos':'إضافة صور',
    'JPG, PNG or WebP · max 5 MB each · drag files here or choose them.':'JPG أو PNG أو WebP · بحد أقصى 5 ميجابايت للصورة · اسحب الصور هنا أو اخترها.',
    'Add product photos':'أضف صور المنتج',
    'Add 1–6 clear photos. The first photo becomes the main marketplace image.':'أضف من 1 إلى 6 صور واضحة. الصورة الأولى ستكون الصورة الرئيسية في السوق.',
    'Only enter this if you already use your own inventory code.':'اكتب هذا فقط إذا كان لديك بالفعل كود مخزون خاص بك.',
    'Leave blank for automatic SKU':'اتركه فارغًا لإنشاء SKU تلقائيًا',
    'Product SKU':'SKU المنتج',
    'Optional inventory details':'تفاصيل مخزون اختيارية',
    'Pick the closest category. It improves search and lets IzzyDrop suggest better options.':'اختر أقرب فئة. هذا يحسن البحث ويساعد IzzyDrop على اقتراح خيارات أفضل.',
    'Use the name a dropshipper would search for.':'استخدم الاسم الذي سيبحث به الدروبشيبر عن المنتج.',
    'Recommended':'مُفضّل',
    'Required':'مطلوب',
    'Write in either language. IzzyDrop can draft the other one for you.':'اكتب بأي من اللغتين، ويمكن لـ IzzyDrop إعداد مسودة باللغة الأخرى.',
    'Give dropshippers the information they need to understand and find this product.':'أضف المعلومات التي يحتاجها الدروبشيبر لفهم المنتج والعثور عليه.',
    'Create a clean marketplace listing. Start with the essentials — IzzyDrop only shows extra controls when you need them.':'أنشئ عرضًا واضحًا للمنتج في السوق. ابدأ بالأساسيات — ويعرض IzzyDrop التفاصيل الإضافية فقط عند الحاجة.',
    'before IzzyDrop delivery':'قبل توصيل IzzyDrop',
    'Product margin':'هامش المنتج',
    'Each enabled variant can have its own supplier price and suggested selling price.':'يمكن لكل خيار مفعّل أن يكون له سعر مورد وسعر بيع مقترح خاص به.',
    'The product prices below will be used for every variant.':'سيتم استخدام أسعار المنتج بالأسفل لكل الخيارات.',
    'Different prices by variant':'أسعار مختلفة حسب الخيار',
    'Same price for all variants':'نفس السعر لكل الخيارات',
    'Keep one price for everything, or set different prices for specific versions.':'استخدم سعرًا واحدًا لكل الخيارات أو حدّد أسعارًا مختلفة لنسخ معينة.',
    'Variant pricing':'تسعير الخيارات',
    'Choose one photo for each color. Every size of that color will use it.':'اختر صورة واحدة لكل لون. ستستخدم جميع مقاسات هذا اللون نفس الصورة.',
    'Photos by color':'الصور حسب اللون',
    'You can change this — it is only a shortcut.':'يمكنك تغييره — هذا مجرد اختصار.',
    'Use suggestion':'استخدم الاقتراح',
    'Remove option':'حذف الخيار',
    'Quick add':'إضافة سريعة',
    'Separate values with commas':'افصل القيم بفواصل',
    'e.g. Volume':'مثال: السعة',
    'Values':'القيم',
    'Option name':'اسم الخيار',
    'Enter the choices a customer can select.':'أدخل الاختيارات التي يمكن للعميل تحديدها.',
    'Custom option':'خيار مخصص',
    'Add an option above, enter its values, then generate variants.':'أضف خيارًا بالأعلى وأدخل قيمه ثم أنشئ الخيارات.',
    'Stock is required only for versions you keep enabled.':'المخزون مطلوب فقط للنسخ التي تتركها مفعلة.',
    'Sellable versions':'النسخ القابلة للبيع',
    'Update variants':'تحديث الخيارات',
    'Generate variants':'إنشاء الخيارات',
    'Generate the exact combinations, then turn off any version you do not sell.':'أنشئ التركيبات الفعلية ثم أوقف أي نسخة لا تبيعها.',
    'Ready?':'جاهز؟',
    '+ Custom':'+ مخصص',
    'Material':'الخامة',
    'Storage':'السعة',
    'Model':'الموديل',
    'Choose up to 3 option types.':'اختر حتى 3 أنواع من الخيارات.',
    'What changes between versions?':'ما الذي يختلف بين النسخ؟',
    'Choose only what the customer can actually select. IzzyDrop will build the sellable versions for you.':'اختر فقط ما يمكن للعميل تحديده فعليًا. سيقوم IzzyDrop بإنشاء النسخ القابلة للبيع لك.',
