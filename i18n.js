(()=>{
  ...
  const exactAr={
    ...
    'Available':'متاح',
    'More':'المزيد',
    'Add the product normally. Turn on variants only if you need colors, sizes, or other options.':'أضف المنتج بشكل عادي. فعّل الخيارات فقط إذا كنت تحتاج ألوانًا أو مقاسات أو خيارات أخرى.',
    'Review the details above, then add the product to IzzyDrop.':'راجع التفاصيل بالأعلى ثم أضف المنتج إلى IzzyDrop.',
    'Ready to publish?':'جاهز للنشر؟',
    'Set your stock and the prices dropshippers need.':'حدد المخزون والأسعار التي يحتاجها الدروبشيبر.',
    'Price, stock & shipping':'السعر والمخزون والشحن',
    'Use one stock only':'استخدم مخزونًا واحدًا فقط',
    'This product has colors, sizes, or options':'هذا المنتج له ألوان أو مقاسات أو خيارات',
    'Leave this off for a normal product with one stock number. Turn it on only when customers choose between versions.':'اترك هذا الخيار مغلقًا للمنتج العادي الذي له مخزون واحد. فعّله فقط عندما يختار العميل بين نسخ مختلفة.',
    'Does this product have colors, sizes, or options?':'هل لهذا المنتج ألوان أو مقاسات أو خيارات؟',
    ...
    'Color photo':'صورة اللون',
    'Use main product photo':'استخدم صورة المنتج الرئيسية',
    'Sizes & stock':'المقاسات والمخزون',
    'Each size has its own stock.':'لكل مقاس مخزونه الخاص.',
    'Add size':'أضف مقاسًا',
    'Remove size':'حذف المقاس',
    'Add at least one color.':'أضف لونًا واحدًا على الأقل.',

    'Add variants one by one':'أضف الخيارات واحدًا واحدًا',
    'Create only the exact versions you actually sell. Add a photo, color, size, stock, and optional different price for each one.':'أنشئ فقط النسخ التي تبيعها فعليًا. أضف صورة ولونًا ومقاسًا ومخزونًا وسعرًا مختلفًا اختياريًا لكل خيار.',
    'Add next variant':'أضف الخيار التالي',
    'Add the exact version you have in stock.':'أضف النسخة الفعلية الموجودة لديك في المخزون.',
    'Remove variant':'حذف الخيار',
    'Upload photo':'رفع صورة',
    'Main product photo':'صورة المنتج الرئيسية',
    'Color':'اللون',
    'Size':'المقاس',
    'optional':'اختياري',
    'e.g. Black':'مثال: أسود',
    'e.g. M':'مثال: M',
    'Different supplier price':'سعر مورد مختلف',
    'Model / other option':'الموديل / خيار آخر',
    'e.g. 256 GB':'مثال: 256 GB',
    'Variant SKU':'SKU للخيار',
    'Auto if blank':'تلقائي إذا تركته فارغًا',
    'Add at least one variant.':'أضف خيارًا واحدًا على الأقل.',
    'Optional general product photos. You can also add a photo while creating each variant.':'صور عامة اختيارية للمنتج. يمكنك أيضًا إضافة صورة أثناء إنشاء كل خيار.',
    ...
    'You can add up to 6 product photos.':'يمكنك إضافة حتى 6 صور للمنتج.',

    'Requests':'الطلبات',
    'What needs your attention.':'ما يحتاج انتباهك.',
    ...
    'Product':'المنتج',
    'Name & photos':'الاسم والصور',
    'Variants':'الخيارات',
    'Stock & options':'المخزون والخيارات',
    'Price':'السعر',
    'Price & publish':'السعر والنشر',
    'Basic information':'المعلومات الأساسية',
    'Photos':'الصور',
    'Does this product have options?':'هل للمنتج خيارات؟',
    'Use one version, or add colors, sizes, models, or any other option.':'استخدم نسخة واحدة أو أضف ألوانًا أو مقاسات أو موديلات أو أي خيار آخر.',
    'Advanced details':'تفاصيل متقدمة',
    'Hide advanced details':'إخفاء التفاصيل المتقدمة',
    'Price & shipping':'السعر والشحن',
    'Tell dropshippers what they pay you and what you recommend they sell for.':'حدد ما يدفعه لك الدروبشيبر وسعر البيع الذي تقترحه.',
    'Product details':'بيانات المنتج',
    'Add the name, category and photos.':'أضف الاسم والفئة والصور.',
    'Variants & stock':'الخيارات والمخزون',
    'Choose one version or create color and size combinations.':'اختر نسخة واحدة أو أنشئ تركيبات الألوان والمقاسات.',
    'Set the price and publish when everything looks right.':'حدد السعر ثم انشر المنتج عندما يصبح جاهزًا.',
    'Next: Variants':'التالي: الخيارات',
    'Next: Price':'التالي: السعر',
    'Publish product':'نشر المنتج',
    'Publishing…':'جارٍ النشر…',
    'Preparing translation…':'جارٍ تجهيز الترجمة…',
    'Add a product name first.':'أضف اسم المنتج أولًا.',
    'Choose a product category.':'اختر فئة للمنتج.',
    'Enter your supplier price.':'أدخل سعر المورّد.',
    'Enter a suggested selling price.':'أدخل سعر البيع المقترح.',
    'Enter a valid shipping cost.':'أدخل تكلفة شحن صحيحة.',
